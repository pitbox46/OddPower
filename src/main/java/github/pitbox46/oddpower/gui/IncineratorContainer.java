...
public class IncineratorContainer extends AbstractGeneratorContainer{
    /**
     ...
     */
    public IncineratorContainer(@Nullable ContainerType<?> type, int id, BlockPos blockPos, PlayerInventory playerInventory, Block block) {
